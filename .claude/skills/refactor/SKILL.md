---
name: refactor
description: Systematically analyze and refactor code to improve quality without changing external behavior — extract functions, simplify conditionals, remove dead code, apply incrementally with test verification. Use when the user asks to refactor, clean up, or restructure code.
---
