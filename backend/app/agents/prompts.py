...
DIAGNOSIS_SYSTEM_PROMPT = (
    ...
    "somut bir iddia taşısın. Bu kazanım sonraki/ileri düzey kazanımların temelini "
    "oluşturduğundan, eksikliğin sonraki öğrenmelere sarmal (kümülatif) bir risk oluşturup "
    "oluşturmadığını da kısaca ekle - yalnızca bu riski TEŞHİS ET, nasıl giderileceğini önerme "
    "(madde 5).\n"
